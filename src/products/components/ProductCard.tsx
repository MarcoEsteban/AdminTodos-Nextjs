    ...
    <div className="bg-white shadow rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-100">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          ...
          {/* Stars */ }
          {/* Array(number) :: Me crea un Array con la cantidad de elemento que le pasemos */ }
          {/* fill(0)       :: Indico que llene de ceros a cada elemento [0, 0, 0, ...etc] */ }
          {
          ...
          <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">
            { rating.toFixed( 2 ) } {/* Indico que tenga 2 decimales con 'toFixec(2)' */ }
          </span>
        </div>
